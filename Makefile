...
STRESS_TARGET := tyrian_gba_full_loadout_sprite_stress_$(STRESS_RUN_TAG)_v70_$(STRESS_DIAGNOSTIC)_hotpath$(HOTPATH_ASM)_$(CONFIG_SUFFIX)_exactasm$(SPRITE2_EXACT_LOOKUP_ASM)
...
RES := res
STRESS_MAIN_OBJECT := \
	$(BUILD)/main_full_loadout_stress_$(STRESS_RUN_TAG)_$(STRESS_DIAGNOSTIC)_hotpath$(HOTPATH_ASM)_$(CONFIG_SUFFIX)_exactasm$(SPRITE2_EXACT_LOOKUP_ASM).o
