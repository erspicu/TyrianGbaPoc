...
STRESS_TARGET := tyrian_gba_full_loadout_sprite_stress_$(STRESS_RUN_TAG)_v70_$(STRESS_DIAGNOSTIC)_hotpath$(HOTPATH_ASM)_$(CONFIG_SUFFIX)_x$(SPRITE2_EXACT_LOOKUP_ASM)_s$(STARFIELD_BATCH_ASM)_ph$(PROJECTILE_CACHE_HINT)_pa$(PROJECTILE_HINT_ASM)_fx$(EFFECT_ACTIVE_MASK)_bs$(POOL_BIT_SCAN_ASM)_sf$(PLAYER_SHOT_FREE_MASK)_su$(PLAYER_SHOT_UPDATE_MASK)_em$(ENEMY_ACTIVE_MASK)
...
RES := res
STRESS_MAIN_OBJECT := \
	$(BUILD)/main_full_loadout_stress_$(STRESS_RUN_TAG)_$(STRESS_DIAGNOSTIC)_hotpath$(HOTPATH_ASM)_$(CONFIG_SUFFIX)_x$(SPRITE2_EXACT_LOOKUP_ASM)_s$(STARFIELD_BATCH_ASM)_ph$(PROJECTILE_CACHE_HINT)_pa$(PROJECTILE_HINT_ASM)_fx$(EFFECT_ACTIVE_MASK)_bs$(POOL_BIT_SCAN_ASM)_sf$(PLAYER_SHOT_FREE_MASK)_su$(PLAYER_SHOT_UPDATE_MASK)_em$(ENEMY_ACTIVE_MASK).o
...
STRESS_LEVEL_OBJECT := \
	$(BUILD)/opentyrian_level_port_stress_$(STRESS_DIAGNOSTIC)_hotpath$(HOTPATH_ASM)_$(CONFIG_SUFFIX)_em$(ENEMY_ACTIVE_MASK).o
